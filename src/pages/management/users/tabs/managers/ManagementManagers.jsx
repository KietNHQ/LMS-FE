...
export default function ManagementManagers({ onCountChange, schoolYear, hasPermission }) {
    ...
    const handleBulkResetPassword = async () => {
        ...
        setConfirmConfig({
            ...
            message: `Để đặt lại mật khẩu cho ${selectedUserIds.length} tài khoản, vui lòng nhập mật khẩu Quản lý của bạn:`,
    ...
    /* ── Render ── */
    return (
        <div className="management-managers-page">
            ...
            <div className="users-toolbar-card">
                ...
                <div className="users-filter-group">
                    <div className="management-managers-filter-select-wrap">
                        <Select
                            variant="custom"
                            value={roleFilter}
                    ...
                    <button className="management-managers-add-btn" onClick={() => { setFormData(emptyForm); setCreateOpen(true); }}>
                        <FiPlus /> Thêm Cán bộ
                    </button>
                </div>
            </div>
            ...
            {/* Table (Modernized) */}
            {isLoading && <div className="management-managers-state-msg">Đang tải danh sách Cán bộ...</div>}
            {loadError && <div className="management-managers-state-msg">{loadError}</div>}
            ...
            {!isLoading && !loadError && filtered.length > ITEMS_PER_PAGE && (
                <div className="management-managers-pagination-row">
                    <Pagination
