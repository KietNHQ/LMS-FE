...
export default function ManagementStudents({ onCountChange, schoolYear, term, hasPermission, currentUser }) {
  ...
  const handleBulkResetPassword = async () => {
    ...
    setConfirmConfig({
      ...
      message: `Để đặt lại mật khẩu cho ${selectedUserIds.length} học sinh, vui lòng nhập mật khẩu Quản lý của bạn:`,
      ...
      {shouldRenderDataSection && (
        <>
          ...
          {hasFilteredStudents && totalPages > 1 && (
            <div className="management-students-pagination-row">
              <Pagination
