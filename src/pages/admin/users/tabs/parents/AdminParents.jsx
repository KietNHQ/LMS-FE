...
export default function AdminParents({ onCountChange, schoolYear, term }) {
    ...
    const filteredParents = useMemo(() => {
        return parents.map((parent) => {
            ...
            const targetStart = parseInt(schoolYear.split("-")[0]);
    ...
    }, [parents, searchTerm, selectedStatus, selectedClass, schoolYear]);
