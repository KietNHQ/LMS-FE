        ...
        <div className="teacher-quiz-list-section">
            {quizzes && quizzes.length > 0 ? (
                <div className="teacher-quiz-list-grid">
                    {quizzes.map((quiz) => {
                        const submissionCount = quiz.submissionCount ?? (quiz.submissions?.length || 0);
                            ...
                            >
                                ...
                                {submissionCount > 0 ? (
                                    <p className="teacher-quiz-card__grading-status">
                                        Đã nộp: {submissionCount} - {quiz.gradingStatus === "graded" || quiz.isScoreReadyForGradebook ? "Đã hoàn tất chấm" : "Đang chờ chấm tự luận"}
                                    </p>
                                ) : (
