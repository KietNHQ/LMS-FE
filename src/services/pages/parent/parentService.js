...
const PARENT_ENDPOINTS = [
  ...
  { key: "post_parent_messages", method: "POST", path: "/api/v1/guardians/me/messages", module: "messages", mock: (input) => ({ id: Date.now(), ...(input.body || {}), createdAt: new Date().toISOString() }) },
  { key: "get_parent_notifications", method: "GET", path: "/api/v1/guardians/me/notifications", module: "notifications", mock: () => PARENT_NOTIFICATIONS_MOCK },
  { key: "patch_parent_notifications_mark_all_read", method: "PATCH", path: "/api/v1/guardians/me/notifications/mark-all-read", module: "notifications", mock: () => ({ updated: true }) },
  { key: "patch_parent_notifications_by_id_read", method: "PATCH", path: "/api/v1/guardians/me/notifications/:id/read", module: "notifications", mock: (input) => ({ id: input.pathParams?.id, unread: false }) },
  { key: "patch_parent_notifications_by_id_toggle", method: "PATCH", path: "/api/v1/guardians/me/notifications/:id/toggle-important", module: "notifications", mock: (input) => ({ id: input.pathParams?.id, important: true }) },
  { key: "get_parent_payments", method: "GET", path: "/api/v1/guardians/me/payments", module: "payments", mock: () => PARENT_PAYMENTS_MOCK },
  { key: "get_parent_payments_by_id", method: "GET", path: "/api/v1/guardians/me/payments/:id", module: "payments", mock: (input) => PARENT_PAYMENTS_MOCK.find((item) => `${item.id}` === `${input.pathParams?.id}`) || null },
